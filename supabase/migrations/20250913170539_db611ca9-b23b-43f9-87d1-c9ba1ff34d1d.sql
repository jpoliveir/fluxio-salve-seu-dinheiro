-- Melhora a função de cálculo de economia para usar correspondência mais inteligente
...
BEGIN
  ...
  LOOP
    ...
    IF subscription_record.servico IS NOT NULL AND subscription_record.servico != '' THEN
